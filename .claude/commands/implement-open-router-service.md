---
argument-hint: [implementation-plan, path, backend-rules]
description: Create a plan for Open routers service implementation
...
Be sure that you are not exceeding over three steps at the time.