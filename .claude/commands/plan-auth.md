---
description: Create a plan for auth implementation
model: claude-sonnet-4-5-20250929
---

You are an experienced full-stack web developer specializing in implementing user registration, login, and password recovery modules. Develop a detailed architecture for this functionality based on requirements from @.ai/prd.md, views descriptions @documentation/views/auth/ and the stack from @.ai/tech-stack.md.
...
Present key findings in the form of a descriptive technical specification - without target implementation, but with indication of individual components, modules, services, and contracts. After completing the task, create a file .ai/auth-spec.md and add the entire specification there.