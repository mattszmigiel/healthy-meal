...
Remember to save your implementation plan as .ai/{route-api-name}.md. Ensure the plan is detailed, clear, and provides comprehensive guidance for the development team.